...
class Vec2
{
    public:
        ...
        void add_self(T a_ ) { x+=a_; y+=a_; }
        void add_self( Vec2<T>& v_ ) { x+=v_.x, y+=v_.y; }

        void sub_self( T a_ ) { x-=a_; y-=a_;  }
        void sub_self( Vec2<T>& v_ ) { x-=v_.x; y-=v_.y; }

        void mul_self( T a_ ) { x*=a_; y*=a_; }
        void mul_self( Vec2<T>& v_ ) { x*=v_.x; y*=v_.y; }

        void div_self( T a_ ) { x/=a_; y/=a_; }
        void div_self( Vec2<T>& v_ ) { x/=v_.x; y/=v_.y; }
