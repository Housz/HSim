...
namespace HSim
{
    ...
    public:
        ...
        {
            container[0] = m_(0); container[1] = m_(1); container[2] =  m_(2);
            container[4] = m_(3); container[5] = m_(4); container[6] =  m_(5);
            container[8] = m_(6); container[9] = m_(7); container[10] = m_(8);
        }
    ...
    public:
        ...
        T determinant() const
        {
            return container[0] * container[5] * container[10] * container[15] + container[0] * container[6] * container[11] * container[13] + container[0] * container[7] * container[9] * container[14] +
    ...
    template <typename T1>
    inline std::ostream &operator<<(std::ostream &os, Mat44<T1> &m)
    {
    ...
    inline Mat44<T1> operator+(const Mat44<T1> &m1, const Mat44<T2> &m2)
    {
        return m1.add(m2);
    }
    ...
    // mat + n
    template <typename T1, typename T2>
    inline Mat44<T1> operator+(const Mat44<T1> &m_, T2 value)
    {
        return m_.add(value);
    }
    // n + mat
    template <typename T1, typename T2>
    inline Mat44<T1> operator+(T1 value, const Mat44<T2> &m_)
    {
        return m_.add(value);
    }
    ...
    // n * mat
    template <typename T1, typename T2>
    inline Mat44<T2> operator*(T1 value, const Mat44<T2> &m_)
    {
        return m_.mul(value);
    }
    ...
    template <typename T1, typename T2>
    inline Vec4<T2> operator*(const Mat44<T1> &m_, const Vec4<T2> &v_)
    {
        Vec4<T2> v(
    ...
    template <typename T1, typename T2>
    inline Vec4<T2> operator*(const Vec4<T1> &v_, const Mat44<T2> &m_)
    {
        Vec4<T2> v(
            m_(0) * v_(0) + m_(1) * v_(1) + m_(2) * v_(2) + m_(3) * v_(3),
            m_(4) * v_(0) + m_(5) * v_(1) + m_(6) * v_(2) + m_(7) * v_(3),
