...
namespace HSim
{
	Ray3<float> Camera::castRayInWorldSpace(float x, float y)
	{
		...
		ray.direction = Vec3f(far_world.x - near_world.x, far_world.y - near_world.y, far_world.z - near_world.z).getNormalized();
